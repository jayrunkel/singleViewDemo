...
#./bin/sparkR --conf "spark.mongodb.input.uri=mongodb://localhost/counties.countyCrimeAlcoholCensus" --conf "spark.mongodb.output.uri=mongodb://localhost/counties.testR" --packages org.mongodb.spark:mongo-spark-connector_2.11:2.0.0
...
censusDF <- loadDF("",
                    source = "com.mongodb.spark.sql.DefaultSource",
		    uri = "mongodb://localhost/counties.countySingleView")
